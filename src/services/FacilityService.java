...
public class FacilityService implements IFacilityService {
    ...
    static {
        ...
        Villa villa1 = new Villa("Pool villa", 320, 2000000, 5, RentalType.RentByDay.name(), "Three Bedrooms", 20, 2);
        Villa villa2 = new Villa("Garden villa", 220, 1500000, 4, RentalType.RentByMonth.name(), "Two Bedrooms", 15, 3);
        Villa villa3 = new Villa("Beach front villa", 250, 2500000, 3, RentalType.RentByYear.name(), "Five Bedrooms", 25, 1);
        Room room1 = new Room("Garden deluxe", 40, 1500000, 2, RentalType.RentByDay.name(), "Free BreakFast");
        Room room2 = new Room("Beach deluxe", 30, 2000000, 2, RentalType.RentByMonth.name(), "Free Gym");
        Room room3 = new Room("Presidential suite", 45, 3000000, 3, RentalType.RentByYear.name(), "Free Spa");
